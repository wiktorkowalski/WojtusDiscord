        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_message_mentions_target", "(mention_type IN (0,1) AND ((mentioned_user_discord_id IS NOT NULL AND mentioned_role_discord_id IS NULL) OR (mentioned_user_discord_id IS NULL AND mentioned_role_discord_id IS NOT NULL))) OR (mention_type IN (2,3) AND mentioned_user_discord_id IS NULL AND mentioned_role_discord_id IS NULL)");
                    table.ForeignKey(
